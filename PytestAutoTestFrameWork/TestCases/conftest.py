...
#     yield
#     driver.refresh()
# userName = do_conf.get_locators_or_account('OdooLoginAccount', 'username')
# passWord = do_conf.get_locators_or_account('OdooLoginAccount', 'password')

@pytest.fixture(scope='class')
def ini_pages(driver):
    login_odoo=LoginOdoo(driver)
    yield driver,login_odoo
